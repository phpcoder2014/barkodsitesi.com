...
<?php include_once("includes/menu.php"); ?>	
		<section id="content">			
			<div class="g12">
			<h1>Yorumlar <span><a href="#" class="small">acilbarkod.com</a></span></h1>		
			<p>Tüm yorum işlemlerinizi buradan yapabilirsiniz<br>
			Yorum Listeleri ve Kayıt İşlemleri</p>
				<form id="form" action="yorum_ekle.php?goster=kaydet" method="post" autocomplete="off">
					<fieldset>
						<label>YENI YORUM KAYDI</label>
						...
						<section>
							...
							<button type="submit" class="big" >Yorum Gönder</button>
							</div>
						</section>
					</fieldset>			
				</form>
